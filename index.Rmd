...
documentclass: book
bibliography: [book.bib, testbib.bib]
biblio-style: authoryear-jst
link-citations: yes
...
不明な点があれば,Twitterの(https://twitter.com/kazutan) もしくはこのリポジトリのissue,あるいはr-wakalangのrmarkdownのチャンネルまでおねがいします。
